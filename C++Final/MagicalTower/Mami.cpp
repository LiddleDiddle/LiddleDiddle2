...
void Mami::init(int controllerNumber, float x, float y, b2World* world) {
	_world = world;
...
void Mami::update(float timeStep){
	if (_alive)
	{
...
void Mami::draw(Bengine::SpriteBatch& spriteBatch){
