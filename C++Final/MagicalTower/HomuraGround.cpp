...
CharacterState* HomuraGround::update(b2Body &body, int controllerNumber, int contacts){
...
void HomuraGround::draw(Bengine::SpriteBatch& spriteBatch, b2Body *body)
{
	if (body->GetLinearVelocity().x <= 0.3 && body->GetLinearVelocity().x >= -0.3)
	{
		_texture = Bengine::ResourceManager::getTexture("Textures/Homura/idle.png");
...
void HomuraGround::processInputs(int controllerNumber){
