...
void Sayaka::init(int controllerNumber, float x, float y, b2World* world) {
	_world = world;
	...
	_mana = 100;
	_alive = true;
	_currentState = new SayakaGround;
	_currentState->enter();
...
void Sayaka::update(float timeStep){
	if (_alive)
	{
...
void Sayaka::draw(Bengine::SpriteBatch& spriteBatch){
